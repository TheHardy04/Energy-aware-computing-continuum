...
\acf{CC} has established itself as the ubiquitous backbone of modern computing environments, offering scalable storage and processing power that enables organizations to access vast resources without significant upfront capital expenditure. While this centralized model provides the elasticity required for computation-intensive applications, it increasingly faces limitations driven by the explosive growth of the \acf{IoT}. With projections indicating that the number of interconnected devices will reach approximately 125 billion by 2030, the massive volume of data generated threatens to cause significant network congestion and high latency when processed solely by remote cloud servers.
...
However, the expansion of this distributed infrastructure raises critical concerns regarding sustainability. It is estimated that by 2030, data centers alone could consume up to 8\% of the global electrical supply, a significant portion of which is still derived from non-renewable sources \cite{jones2018stop}. As a result, energy efficiency has become a primary constraint in the design of computing architectures. Addressing this requires robust mathematical models to quantify and optimize energy consumption across the entire continuum, ranging from utilization-based heuristics for servers to complex physics-based formulations for IoT devices and network infrastructure.
