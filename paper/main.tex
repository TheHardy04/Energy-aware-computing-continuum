...
The remainder of this article is organized as follows. \Cref{sec:background} presents an overview of the foundational computing paradigms—Cloud, Fog, and Edge—and introduces the concept of the unified Cloud-Edge Computing Continuum. \Cref{sec:energy_formulation} provides a detailed literature review of mathematical energy formulations, categorized into server and cloud models, IoT-specific constraints, and communication energy costs. Finally, the report synthesizes these findings through comparative tables summarizing key optimization objectives and measurement methodologies found in recent research.
...
\subsubsection{Simulation Tools and Frameworks}

Simulations provide a scalable, cost-effective alternative to physical measurements in complex, highly distributed environments. It model new research ideas for parts of a system (processor, memory, accelerator and others) or a complete system and estimate metrics such as performance and energy \cite{muralidhar2022energy}.

\paragraph{iFogSim} \cite{gupta2017ifogsim}
Built upon 
