...
\vspace{0.1cm}
\begin{center}
  {\large \textbf{Simulation Setup: Infrastructure and DSP}}
\includegraphics[width=\linewidth]{SimulationSetup.png}
\end{center}

\begin{center}
  {\large\textbf{VMs GCE used in the case study}}
\end{center}
...
vm/.style={draw, dashed, rounded corners, minimum width=2cm, minimum height=1.9cm, thick, color=gray},
...
\end{minipage}
\begin{center}
\large\textbf{Storm Topology Deployment}
\end{center}
}
}
...
\vspace{-0.5cm}
\begin{center}
\large\textbf{Placement Algorithm Comparison}
...
%	CONCLUSION
%----------------------------------------------------------------------------------------
\headerbox{Conclusion \& Perspectives}{name=conclusion,column=0,below=taxonomy,above=bottom,span=3}{
...
%	REFERENCES
%----------------------------------------------------------------------------------------
\headerbox{References}{name=references,column=3,below=results, above=bottom, span=3}{
  \vspace{-0.5cm}
\smaller
